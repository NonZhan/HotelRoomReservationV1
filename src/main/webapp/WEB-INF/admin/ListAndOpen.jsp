...
<html>
    ...
    <body>
        ...
        <form method="POST" action="FilterInvoice">
    ...
    <center>
            <form action="FilterLink" method="POST">
                <input type="hidden" name="link" value="doAddopenroomJSP"/>
                <button><fmt:message key="ADDROOM"/></button>   
            </form>

            <form action="FilterLink" method="POST">
                <input type="hidden" name="link" value="doDeleteRoomJSP"/>
                <button class="button"><fmt:message key="DELETEROOM"/></button>   
            </form>
    </center>    
        <br><br>
