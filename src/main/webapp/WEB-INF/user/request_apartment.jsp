...
<html>
    ...
    <body>
        ...
        <form action="FilterLink" method="POST">
            <input type="hidden" name="link" value="doWait_orderJSP"/>
            <button class="button"><img height="250px" src="img/wait_order.png"/></button>   
        </form>

    <div class="request_apartment">
        
        <form method="POST" action="FilterRequestApartment">
